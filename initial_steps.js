...
str.slice(i, j); //позволяет вывести часть строки (элемент строки с индексом второго аргумента не входит в выводимый результат), метод поддерживает отрицательные аргументы тогда счет идет с конца строки
